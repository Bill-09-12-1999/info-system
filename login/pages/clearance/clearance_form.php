        ...
        <div class="col-xs-12 col-sm-6 col-md-8" style="" >
            <div style=" background: black;" >
                <div class="col-xs-4 col-sm-6 col-md-3" style="background: white; margin-right:10px; border: 2px solid black;">
                    <center><image src="../../img/logo.png" style="width:80%;height:164px;"/></center>
                ...
                <div class="col-xs-7 col-sm-5 col-md-8" style="background: white;  ">
                    <div class="pull-left" style="font-size: 16px;"><b><br>
                        ...
                        <?php
                            ...
                            while($row = mysqli_fetch_array($qry)){
                                ...
                                <p>
                                    ...
                                    BIRTHDATE & PLACE: <b><u>'.strtoupper(date_format($bdate,"m-d-Y")) .'/'.strtoupper($row['bplace']).'</u></b><br>
                                    GENDER/CIVIL STATUS: <b><u>'.strtoupper($row['gender']) .'/SINGLE</u></b><br>
